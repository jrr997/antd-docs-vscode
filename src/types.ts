...
export type ComponentParseConfig = CommonParseConfig | CustomParseConfig;
...
export type CustomParser = (config: ComponentParseConfig, docsMapItem: DocsMap[string], processor: Processor<Root, Root, Root, string>) => PendingComponent;